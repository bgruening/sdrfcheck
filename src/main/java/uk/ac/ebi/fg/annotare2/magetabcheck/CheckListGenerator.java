...
public class CheckListGenerator {
    ...
    private static final Map<String, RefList> refs = new HashMap<>();

    static {
        refs.put("#protocol-hardware-list", new ProtocolHardwareList());
        refs.put("#term-source-list", new TermSourceList());
    }
    ...
    private String markdown() {
        ...
        List<MageTabCheck> checks = new ArrayList<>();
    ...
    private static class MarkdownChecks {
        ...
        private MarkdownChecks() {
            this.refs = CheckListGenerator.refs;
        }
    ...
    private static class ProtocolHardwareList extends RefList {
        private ProtocolHardwareList() {
            super("Supported protocol hardware list");
            addAll(KnownProtocolHardware.LIST);
        }
    }

    private static class TermSourceList extends RefList {
        private TermSourceList() {
            super("Term source list");
