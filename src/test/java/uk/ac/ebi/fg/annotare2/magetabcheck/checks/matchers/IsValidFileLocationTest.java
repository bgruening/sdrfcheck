...
public class IsValidFileLocationTest {
    ...
    public void testHttpUrl() throws MalformedURLException {
        assertTrue(isValidFileLocation().matches(new FileLocation("https://www.ebi.ac.uk")));
        assertFalse(isValidFileLocation().matches(new FileLocation("https://www.ebi.ac.ukk")));
    }

    @Test
    public void testHttpsUrl() throws MalformedURLException {
        assertTrue(isValidFileLocation().matches(new FileLocation("https://www.ebi.ac.uk")));
        assertFalse(isValidFileLocation().matches(new FileLocation("http://www.ebi.ac.uk")));
    }
